...
// Build task
gulp.task('build',gulp.series(['clean','copy','html:build','sass','images','webp','symbols']), function(done) { 
...
// Default task
gulp.task('default',gulp.series(['clean','copy','html:build','sass','images','webp','symbols','serve']), function(done) { 
